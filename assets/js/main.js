...
(function () {
  ...
  /* ---------- Floating rounded nav / glass menu / glass search / animated details ---------- */
  function injectFloatingNavStyle() {
    ...
    style.textContent = [
      ...
      '  pointer-events:none;',
      '  transition:transform .32s cubic-bezier(.16,.84,.28,1), opacity .22s ease, filter .22s ease!important;',
      '  will-change:transform,opacity,filter;',
      '}',
      '.nav.nav--hiding{',
      '  filter:blur(8px) saturate(180%) brightness(1.08);',
      '}',
      '.nav.nav--hidden{',
      '  transform:translateX(-50%) translateY(-96px) scale(.985)!important;',
      '  opacity:0;',
      '  filter:blur(16px) saturate(240%) brightness(1.14);',
      '}',
      '.nav__inner{',
      '  width:100%!important;',
      ...
      '  transition:background .3s ease,border-color .3s ease,box-shadow .3s ease,filter .22s ease,transform .22s ease;',
      '}',
      ...
      '.nav__sub-toggle,.nav__search-btn,.nav__theme,.nav__sidebar-toggle,.nav__menu a{',
      ...
      '.nav__has-sub:hover>.nav__sub-toggle,.nav__has-sub:focus-within>.nav__sub-toggle,.nav__menu a.active{',
      ...
      '}',
      '[data-theme="dark"] .nav__has-sub:hover>.nav__sub-toggle,[data-theme="dark"] .nav__has-sub:focus-within>.nav__sub-toggle,[data-theme="dark"] .nav__menu a.active,',
      ...
      '  box-shadow:0 24px 70px rgba(0,0,0,.20), inset 0 1px 0 rgba(255,255,255,.72)!important;',
      ...
      '  transition:opacity .22s ease,visibility .22s ease,transform .28s cubic-bezier(.2,.7,.2,1)!important;',
      ...
      '  background:rgba(22,22,24,.76)!important;',
      ...
      '  .nav__menu{gap:3px!important;}',
      '  .nav__menu a,.nav__sub-toggle{padding-left:8px!important;padding-right:8px!important;}',
      '  .nav__submenu{right:-8px!important;min-width:230px!important;border-radius:24px!important;}',
      '}',
      '@media(prefers-reduced-motion:reduce){',
      '  .nav,.nav__inner,.nav__submenu,.article details.details-anim .prompt-content{transition:none!important;}',
      '}',
      '@supports not ((backdrop-filter: blur(1px)) or (-webkit-backdrop-filter: blur(1px))){',
      '  .nav__inner,.nav__submenu,.nav-search{background:rgba(251,251,253,.94)!important;}',
      '  [data-theme="dark"] .nav__inner,[data-theme="dark"] .nav__submenu,[data-theme="dark"] .nav-search{background:rgba(22,22,24,.94)!important;}',
      '}'
    ].join('\n');
  ...
  function openSidebar() {
    ...
    var nav = document.querySelector('.nav');
    if (nav) nav.classList.remove('nav--hidden', 'nav--hiding');
  }
