...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '.hero__actions .btn--primary::after{content:""!important;position:absolute!important;inset:-42% -28%!important;border-radius:inherit!important;background:linear-gradient(100deg,transparent 18%,rgba(255,255,255,.82) 36%,rgba(255,255,255,.25) 50%,transparent 66%)!important;transform:translateX(-120%) rotate(8deg)!important;z-index:0!important;pointer-events:none!important;animation:wyqRainbowShine 3.4s cubic-bezier(.2,.7,.2,1) infinite!important;}',
