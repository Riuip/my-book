...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '.hero__actions .btn--primary{position:relative!important;isolation:isolate!important;overflow:hidden!important;color:#fff!important;border:1px solid rgba(255,255,255,.52)!important;background:linear-gradient(115deg,#007aff 0%,#00c7ff 16%,#34c759 31%,#ffd60a 47%,#ff9f0a 60%,#ff375f 74%,#bf5af2 88%,#007aff 100%)!important;background-size:260% 260%!important;box-shadow:0 18px 42px rgba(0,122,255,.30),0 8px 18px rgba(191,90,242,.18),inset 0 1px 0 rgba(255,255,255,.58),inset 0 -1px 0 rgba(0,0,0,.16)!important;text-shadow:0 1px 10px rgba(0,0,0,.18)!important;animation:wyqRainbowFlow 7s ease-in-out infinite!important;}',
      '.hero__actions .btn--primary::before{content:""!important;position:absolute!important;inset:1px!important;border-radius:inherit!important;background:linear-gradient(180deg,rgba(255,255,255,.42),rgba(255,255,255,.12) 36%,rgba(255,255,255,0) 58%)!important;mix-blend-mode:screen!important;z-index:-1!important;pointer-events:none!important;}',
      '.hero__actions .btn--primary::after{content:""!important;position:absolute!important;inset:-42% -28%!important;border-radius:inherit!important;background:linear-gradient(100deg,transparent 18%,rgba(255,255,255,.76) 36%,rgba(255,255,255,.18) 48%,transparent 64%)!important;transform:translateX(-120%) rotate(8deg)!important;z-index:0!important;pointer-events:none!important;animation:wyqRainbowShine 4.8s cubic-bezier(.2,.7,.2,1) infinite!important;}',
      '.hero__actions .btn--primary span,.hero__actions .btn--primary{z-index:1!important;}',
      '.hero__actions .btn--primary:hover{transform:translateY(-2px) scale(1.015)!important;box-shadow:0 22px 55px rgba(0,122,255,.36),0 12px 28px rgba(255,55,95,.20),0 0 0 1px rgba(255,255,255,.38),inset 0 1px 0 rgba(255,255,255,.62)!important;}',
