...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '.hero__actions .btn--primary{position:relative!important;isolation:isolate!important;overflow:hidden!important;color:#fff!important;border:1px solid rgba(255,255,255,.62)!important;background:linear-gradient(112deg,#ee61d8 0%,#f58bdc 18%,#ffc6bd 36%,#fff0a6 56%,#f5d46e 70%,#bfe6ff 86%,#d8c7ff 100%)!important;background-size:240% 240%!important;box-shadow:0 18px 42px rgba(238,97,216,.22),0 10px 26px rgba(255,198,189,.22),0 8px 20px rgba(191,230,255,.18),inset 0 1px 0 rgba(255,255,255,.68),inset 0 -1px 0 rgba(0,0,0,.10)!important;text-shadow:0 1px 12px rgba(90,48,120,.22)!important;animation:wyqRainbowFlow 8s ease-in-out infinite!important;}',
      '.hero__actions .btn--primary::before{content:""!important;position:absolute!important;inset:1px!important;border-radius:inherit!important;background:linear-gradient(180deg,rgba(255,255,255,.50),rgba(255,255,255,.18) 42%,rgba(255,255,255,0) 66%)!important;mix-blend-mode:screen!important;z-index:-1!important;pointer-events:none!important;}',
      '.hero__actions .btn--primary::after{content:""!important;position:absolute!important;inset:-42% -28%!important;border-radius:inherit!important;background:linear-gradient(100deg,transparent 18%,rgba(255,255,255,.78) 36%,rgba(255,255,255,.22) 50%,transparent 66%)!important;transform:translateX(-120%) rotate(8deg)!important;z-index:0!important;pointer-events:none!important;animation:wyqRainbowShine 5.2s cubic-bezier(.2,.7,.2,1) infinite!important;}',
      '.hero__actions .btn--primary span,.hero__actions .btn--primary{z-index:1!important;}',
      '.hero__actions .btn--primary:hover{transform:translateY(-2px) scale(1.015)!important;box-shadow:0 22px 55px rgba(238,97,216,.30),0 12px 28px rgba(255,198,189,.25),0 0 0 1px rgba(255,255,255,.45),inset 0 1px 0 rgba(255,255,255,.72)!important;}',
