...
- 导航、按钮和浮层才使用光学层。导航子控件共享一个玻璃底，选中/展开项有清楚的胶囊状态；高光与圆角边缘在 Safari 也存在。
...
资源版本：`liquid-glass.css?v=2`、`liquid-optics.css?v=3`、`liquid-optics.js?v=2`。同步更新 HTML 与 `sw.js`，禁止只改资源内容而遗漏版本。
