...
资源版本：`liquid-glass.css?v=2`、`liquid-optics.css?v=5`、`liquid-optics.js?v=3`、`search.js?v=6`；缓存为 `wyq-v13-2026-09-12-glass-loading`。同步更新 HTML 与 `sw.js`，禁止只改资源内容而遗漏版本。
