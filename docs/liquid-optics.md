...
- 透明度按用途区分：浅/深色导航底色不透明度为 12%/28%，普通按钮为 10%/16%；搜索和菜单保留 58%/64% 底色以承载文字。减弱中央白色反光，保留边缘高光；Safari 导航模糊为 8px，Chromium 位移后的模糊为 5px。降低透明度/高对比偏好仍走实色回退。
...
资源版本：`liquid-glass.css?v=2`、`liquid-optics.css?v=6`、`liquid-optics.js?v=4`、`search.js?v=6`；缓存为 `wyq-v14-2026-09-12-clearer-glass`。同步更新 HTML 与 `sw.js`，禁止只改资源内容而遗漏版本。
